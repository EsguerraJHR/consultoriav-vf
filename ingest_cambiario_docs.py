#!/usr/bin/env python
"""
Script para ingestar documentos de Cambiario en Pinecone usando text-embedding-3-large.
"""
...
INDEX_NAME = "cambiario"  # Nombre del índice específico para Cambiario
NAMESPACE = "cambiario"
...
def main():
    ...
    """
    # Directorio donde se encuentran los documentos de Cambiario
    docs_dir = "data/cambiario"
    
    # Verificar si el directorio existe
    if not os.path.exists(docs_dir):
        os.makedirs(docs_dir, exist_ok=True)
        print(f"Directorio {docs_dir} creado. Por favor, coloca tus documentos de Cambiario en este directorio.")
        return
