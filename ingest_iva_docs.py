#!/usr/bin/env python
"""
Script para ingestar documentos de IVA en Pinecone usando text-embedding-3-large.
"""
...
INDEX_NAME = "iva"  # Nombre del índice específico para IVA
NAMESPACE = "iva"
...
def main():
    ...
    """
    # Directorio donde se encuentran los documentos de IVA
    docs_dir = "data/iva"
    
    # Verificar si el directorio existe
    if not os.path.exists(docs_dir):
        os.makedirs(docs_dir, exist_ok=True)
        print(f"Directorio {docs_dir} creado. Por favor, coloca tus documentos de IVA en este directorio.")
        return
