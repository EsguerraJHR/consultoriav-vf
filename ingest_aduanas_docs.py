#!/usr/bin/env python
"""
Script para ingestar documentos de Aduanas en Pinecone usando text-embedding-3-large.
"""
...
INDEX_NAME = "aduanas"  # Nombre del índice específico para Aduanas
NAMESPACE = "aduanas"
...
def main():
    ...
    """
    # Directorio donde se encuentran los documentos de Aduanas
    docs_dir = "data/aduanas"
    
    # Verificar si el directorio existe
    if not os.path.exists(docs_dir):
        os.makedirs(docs_dir, exist_ok=True)
        print(f"Directorio {docs_dir} creado. Por favor, coloca tus documentos de Aduanas en este directorio.")
        return
