#!/usr/bin/env python
"""
Script para ingestar documentos de Impuesto al Consumo en Pinecone usando text-embedding-3-large.
"""
...
INDEX_NAME = "ipoconsumo"  # Nombre del índice específico para Impuesto al Consumo
NAMESPACE = "ipoconsumo"
...
def main():
    ...
    """
    # Directorio donde se encuentran los documentos de Impuesto al Consumo
    docs_dir = "data/ipoconsumo"
    
    # Verificar si el directorio existe
    if not os.path.exists(docs_dir):
        os.makedirs(docs_dir, exist_ok=True)
        print(f"Directorio {docs_dir} creado. Por favor, coloca tus documentos de Impuesto al Consumo en este directorio.")
        return
