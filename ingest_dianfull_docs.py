#!/usr/bin/env python
"""
Script para ingestar documentos de Dian Full en Pinecone usando text-embedding-3-large.
"""
...
INDEX_NAME = "dianfull"  # Nombre del índice específico para Dian Full
NAMESPACE = "dianfull"
...
def main():
    ...
    """
    # Directorio donde se encuentran los documentos de Dian Full
    docs_dir = "data/dianfull"
    
    # Verificar si el directorio existe
    if not os.path.exists(docs_dir):
        os.makedirs(docs_dir, exist_ok=True)
        print(f"Directorio {docs_dir} creado. Por favor, coloca tus documentos de Dian Full en este directorio.")
        return
